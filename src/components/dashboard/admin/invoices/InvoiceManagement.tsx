...
import ManualInvoiceCreation from './ManualInvoiceCreation';
import PenaltyReminderRules from './PenaltyReminderRules';
                ...
                <tbody>
                  {invoices.map((invoice) => (
                    <tr key={invoice.id} className="border-b border-gray-100 hover:bg-gray-50">
                      ...
                      <td className="py-3 px-4 text-gray-900 font-medium">OMR {formatCurrency(invoice.amount)}</td>
